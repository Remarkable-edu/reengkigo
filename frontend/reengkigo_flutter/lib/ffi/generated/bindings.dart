...
/// FFI bindings for Reengkigo Rust library
class ReengkigoBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
  _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  ReengkigoBindings(ffi.DynamicLibrary dynamicLibrary)
    : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ReengkigoBindings.fromLookup(
  ...
  double simple_add(double a, double b) {
    return _simple_add(a, b);
  }

  late final _simple_addPtr =
      _lookup<ffi.NativeFunction<ffi.Double Function(ffi.Double, ffi.Double)>>(
        'simple_add',
      );
  late final _simple_add = _simple_addPtr
      .asFunction<double Function(double, double)>();

  double simple_multiply(double a, double b) {
    return _simple_multiply(a, b);
  }

  late final _simple_multiplyPtr =
      _lookup<ffi.NativeFunction<ffi.Double Function(ffi.Double, ffi.Double)>>(
        'simple_multiply',
      );
  late final _simple_multiply = _simple_multiplyPtr
      .asFunction<double Function(double, double)>();

  ffi.Pointer<ffi.Char> simple_greet(ffi.Pointer<ffi.Char> name) {
    return _simple_greet(name);
  }

  late final _simple_greetPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)
        >
      >('simple_greet');
  late final _simple_greet = _simple_greetPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
  ...
  ffi.Pointer<ffi.Char> test_greet(ffi.Pointer<ffi.Char> name) {
    return _test_greet(name);
  }

  late final _test_greetPtr =
      _lookup<
        ffi.NativeFunction<
          ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)
        >
      >('test_greet');
  late final _test_greet = _test_greetPtr
      .asFunction<ffi.Pointer<ffi.Char> Function(ffi.Pointer<ffi.Char>)>();
}
